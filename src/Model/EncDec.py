...
class EDNet(nn.Module):
    def __init__(self, in_dim, out_dim, size, mult):
        ...
        # Bridge
        self.bridge = ConvBlock2(m * 8, m * 16, size, act, stride=1)
        
        # Up sampling
        self.trans_1 = ConvTransBlock(m * 16, m * 16, size, act)   
        self.up_1 = ConvBlock2(m * 16, m * 8, size, act, stride=1)
        ...
        # Output
        self.out = ConvBlock1(m * 2, out_dim, size, act)
