...
if __name__=='__main__':
    ...
    #pdb_path  = "./" + tp_name
    out_path = '/u1/home/tr443/Projects/ProteinQure/experiments/exp21/output/'
    params_file_name = str(100000) + 'net_params'
    k_size = 3
    ...
    model.eval()
    output = model(volume)
    #output, latent = model(volume)
    #print(latent.shape)
    #latent[latent > 10.0]=10.0
    ...
    pl = pv.Plotter(point_smoothing = True, shape=(11, 2))#, off_screen=True)
    fs = 9
    i_group = 0
    ipdb = 0
